...
export const myRecipeSearchState = { name: 'searchMyRecipes', url: '/search-my',  component: RecipeAccessComponent };
...
export const sharedRecipeSearchState = { name: 'searchSharedRecipes', url: '/search-shared',  component: RecipeAccessComponent };
